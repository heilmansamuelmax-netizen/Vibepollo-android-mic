...
I am an **auto mechanic**, not a professional software engineer. I forked Vibepollo because I wanted **one feature**: the ability to use my **Android TV client's microphone** while streaming to my Windows PC through **[logabell/moonlight-android](https://github.com/logabell/moonlight-android)** (release **v20.2.6-mic-test2**). I did not set out to rewrite Vibepollo or compete with its original authors.
...
| **logabell/moonlight-android** | **Required paired Android TV client** — `app-nonRoot_game-arm64-v8a-debug.apk` / **Artemis-mic** (`com.limelight.noirdebug`, v20.2.6-mic-test2) | [logabell/moonlight-android](https://github.com/logabell/moonlight-android) |
